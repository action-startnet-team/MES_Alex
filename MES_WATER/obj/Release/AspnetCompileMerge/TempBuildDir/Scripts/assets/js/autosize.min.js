...
$(document).ready(function () {
    ...
    $("input[name]").each(function () {
        ...
        if (typeof ($('input[name="' + name + '"]').data('val-required')) === 'undefined') {
            $('label[for ="' + name + '"]').removeClass("required");
        }
        else { $('label[for ="' + name + '"]').addClass("required"); }
        //console.log($('input[name="' + name + '"]').data('val-required'))
    })

    $("textarea[name]").each(function () {
        var name = $(this).attr("name");
        if (typeof ($('textarea[name="' + name + '"]').data('val-required')) === 'undefined') {
            $('label[for ="' + name + '"]').removeClass("required");
        }
        else { $('label[for ="' + name + '"]').addClass("required"); }
        //console.log($('input[name="' + name + '"]').data('val-required'))
    ...
    $("select[name]").each(function () {
        ...
        if ($('select[name ="' + name + '"] > option:nth-child(1)').val() != '') {
            $('label[for ="' + name + '"]').addClass("required");
            $('label[for = "form-field-1"]').eq(i).addClass('required');
        }
        else {
            $('label[for ="' + name + '"]').removeClass("required");
            $('label[for = "form-field-1"]').eq(i).removeClass('required');
        }
        i++;
    })
    } catch (e) { }
