...
namespace MES_WATER.Controllers
{
    ...
    public class AMB020AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "AMB020A";
        //需要用到的Repo
        AMB01_1000Repository repoAMB01_1000 = new AMB01_1000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoAMB01_1000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            AMB01_1000 newData = new AMB01_1000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            AMB01_1000 newData = repoAMB01_1000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, AMB01_1000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoAMB01_1000.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, AMB01_1000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                AMB01_1000 data = new AMB01_1000();
                comm.Set_ModelValue(data, form);
                AMB01_1000 sBefore = comm.GetData<AMB01_1000>(data);
                repoAMB01_1000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            AMB01_1000 sBefore = comm.GetData<AMB01_1000>(pTkCode);
            repoAMB01_1000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, AMB01_1000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<AMB01_1000>(new AMB01_1000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("AMB01_1000", sWhere);
            if (hasRow)
            {
