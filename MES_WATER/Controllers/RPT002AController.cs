...
{
    public class RPT002AController : Controller
    {
        // 共用函數庫
        Comm comm = new Comm();
        ...
        {
            // 報表欄位結構
            List<RPT002A> result = new List<RPT002A>();
        ...
        public List<RPT002A> Get_StatData(JqGridQueryData query_data)
        {
            List<RPT002A> result = new List<RPT002A>();
