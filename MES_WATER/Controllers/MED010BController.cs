...
namespace MES_WATER.Controllers
{
    ...
    public class MED010BController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MED010B";
        //需要用到的Repo
        MED01_0100Repository repoMED01_0100 = new MED01_0100Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMED01_0100.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MED01_0100 newData = new MED01_0100();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MED01_0100 newData = repoMED01_0100.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MED01_0100 model)
        {
            var i = form["is_end"];
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMED01_0100.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MED01_0100 model)
        {
            var i = form["is_end"];
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MED01_0100 sBefore = comm.GetData<MED01_0100>(data);
                repoMED01_0100.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MED01_0100 sBefore = comm.GetData<MED01_0100>(pTkCode);
            repoMED01_0100.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MED01_0100 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MED01_0100>(new MED01_0100());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MED01_0100", sWhere);
            if (hasRow)
            {
