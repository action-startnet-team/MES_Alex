...
namespace MES_WATER.Controllers
{
    ...
    public class QMB010AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "QMB010A";
        //需要用到的Repo
        QMB01_0000Repository repoQMB01_0000 = new QMB01_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoQMB01_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            QMB01_0000 newData = new QMB01_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            QMB01_0000 newData = repoQMB01_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, QMB01_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoQMB01_0000.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, QMB01_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                QMB01_0000 data = new QMB01_0000();
                comm.Set_ModelValue(data, form);
                QMB01_0000 sBefore = comm.GetData<QMB01_0000>(data);
                repoQMB01_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            QMB01_0000 sBefore = comm.GetData<QMB01_0000>(pTkCode);
            repoQMB01_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, QMB01_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<QMB01_0000>(new QMB01_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("QMB01_0000", sWhere);
            if (hasRow)
            {
