...
namespace MES_WATER.Controllers
{
    ...
    public class MEB430AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEB430A";
        //需要用到的Repo
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEB43_0000 newData = new MEB43_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEB43_0000 newData = repoMEB43_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB43_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB43_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoMEB43_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB43_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEB43_0000 sBefore = comm.GetData<MEB43_0000>(data);
                repoMEB43_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoMEB43_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEB43_0000 sBefore = comm.GetData<MEB43_0000>(pTkCode);
            repoMEB43_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB43_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB43_0000>(new MEB43_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB43_0000", sWhere);
            if (hasRow)
            {
