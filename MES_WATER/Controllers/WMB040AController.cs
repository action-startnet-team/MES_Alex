...
namespace MES_WATER.Controllers
{
    ...
    public class WMB040AController : JsonNetController
    {
        //程式代號
         string sPrgCode = "WMB040A";
        //需要用到的Repo
        WMB04_0000Repository repoWMB04_0000 = new WMB04_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoWMB04_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            WMB04_0000 newData = new WMB04_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            WMB04_0000 newData = repoWMB04_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, WMB04_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoWMB04_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoWMB04_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, WMB04_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                WMB04_0000 data = new WMB04_0000();
                comm.Set_ModelValue(data, form);
                WMB04_0000 sBefore = comm.GetData<WMB04_0000>(data);
                repoWMB04_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoWMB04_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            WMB04_0000 sBefore = comm.GetData<WMB04_0000>(pTkCode);
            repoWMB04_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        public JsonResult Get_WMB06_0000Data(string pProCode)
        {
            WMB06_0000 data = new WMB06_0000();

            //string sSql = " select * from WMB06_0000 where pro_code = @pro_code";
            WMB06_0000Repository repoWMB06_0000 = new WMB06_0000Repository();
            data = repoWMB06_0000.GetDTO(pProCode);
        ...
        /// <returns></returns>
        public JsonResult Get_SupAtn(string pro_code)
        {
            string sSql = "select WMB06_0000.* from WMB06_0000 where pro_code = @pro_code ";
