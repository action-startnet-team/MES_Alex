...
namespace MES_WATER.Controllers
{
    ...
    public class QMB140AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "QMB140A";
        //需要用到的Repo
        QMB14_0000Repository repoQMB14_0000 = new QMB14_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoQMB14_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            QMB14_0000 newData = new QMB14_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            QMB14_0000 newData = repoQMB14_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, QMB14_0000 model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                DT.InsertData("QMB14_0000", data);

                //repoQMB14_0000.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, QMB14_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                QMB14_0000 data = new QMB14_0000();
                comm.Set_ModelValue(data, form);
                QMB14_0000 sBefore = comm.GetData<QMB14_0000>(data);

                DT.UpdateData("QMB14_0000", "spc_code", data);
                //repoQMB14_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            QMB14_0000 sBefore = comm.GetData<QMB14_0000>(pTkCode);
            repoQMB14_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, QMB14_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<QMB14_0000>(new QMB14_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("QMB14_0000", sWhere);
            if (hasRow)
            {
        ...
        public string Get_EpbField(string pEpbCode) {
            string sSql = "select * from EPB02_0100" +
                          " where epb_code = @epb_code" +
                          "   and is_key <> 'Y'" +
                          "   and data_type in ('I','F')";
            DataTable dtTmp = comm.Get_DataTable(sSql, "epb_code", pEpbCode);           
            return GD.DataFieldToSTA(dtTmp, "field_code,field_name");
        }
