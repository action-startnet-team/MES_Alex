...
namespace MES_WATER.Controllers
{
    ...
    public class MEB490AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEB490A";
        //需要用到的Repo
        MEB49_0000Repository repoMEB49_0000 = new MEB49_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEB49_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEB49_0000 newData = new MEB49_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEB49_0000 newData = repoMEB49_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB49_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB49_0000.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB49_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEB49_0000 data = new MEB49_0000();
                comm.Set_ModelValue(data, form);
                MEB49_0000 sBefore = comm.GetData<MEB49_0000>(data);
                repoMEB49_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEB49_0000 sBefore = comm.GetData<MEB49_0000>(pTkCode);
            repoMEB49_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB49_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB49_0000>(new MEB49_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB49_0000", sWhere);
            if (hasRow)
            {
