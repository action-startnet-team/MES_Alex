...
namespace MES_WATER.Controllers
{
    ...
    public class MEB100AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEB100A";
        //需要用到的Repo
        MEB10_0000Repository repoMEB10_0000 = new MEB10_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEB10_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEB10_0000 newData = new MEB10_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEB10_0000 newData = repoMEB10_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB10_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB10_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoMEB10_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB10_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEB10_0000 sBefore = comm.GetData<MEB10_0000>(data);
                repoMEB10_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoMEB10_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEB10_0000 sBefore = comm.GetData<MEB10_0000>(pTkCode);
            repoMEB10_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        public JsonResult Chk_Del_Main(FormCollection form)
        {
            ...
            string sFactoryCode = form["factory_code"];

            MEB11_0000Repository repoMEB11_0000 = new MEB11_0000Repository();

            List<MEB11_0000> area_code_list = repoMEB11_0000.Get_DataListByFactoryCode(sFactoryCode);

            if (area_code_list.Count > 0)
            {
                bIsOK = false;
                message += "<div class='text-danger'>";
                message += "<li> " + "此工廠向下尚有區域資料!" + " </li>";
                message += "<li> " + "請確認此工廠無區域資料後再做刪除!" + " </li>";
                message += "</div>";
            }
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB10_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB10_0000>(new MEB10_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB10_0000", sWhere);
            if (hasRow)
            {
