...
namespace MES_WATER.Controllers
{
    ...
    public class EMB210AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "EMB210A";
        //需要用到的Repo
        EMB21_0000Repository repoEMB21_0000 = new EMB21_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoEMB21_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            EMB21_0000 newData = new EMB21_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            EMB21_0000 newData = repoEMB21_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, EMB21_0000 model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                repoEMB21_0000.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, EMB21_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                EMB21_0000 data = new EMB21_0000();
                comm.Set_ModelValue(data, form);
                EMB21_0000 sBefore = comm.GetData<EMB21_0000>(data);
                repoEMB21_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            EMB21_0000 sBefore = comm.GetData<EMB21_0000>(pTkCode);
            repoEMB21_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, EMB21_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<EMB21_0000>(new EMB21_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("EMB21_0000", sWhere);
            if (hasRow)
            {
