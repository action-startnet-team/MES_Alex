...
namespace MES_WATER.Controllers
{
    ...
    public class MEB110AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEB110A";
        //需要用到的Repo
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEB11_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEB11_0000 newData = new MEB11_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEB11_0000 newData = repoMEB11_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB11_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB11_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoMEB11_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB11_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEB11_0000 data = new MEB11_0000();
                comm.Set_ModelValue(data, form);
                MEB11_0000 sBefore = comm.GetData<MEB11_0000>(data);
                repoMEB11_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoMEB11_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEB11_0000 sBefore = comm.GetData<MEB11_0000>(pTkCode);
            repoMEB11_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        public JsonResult Chk_Del_Main(FormCollection form)
        {
            ...
            string sAreaCode = form["area_code"];

            MEB12_0000Repository repoMEB12_0000 = new MEB12_0000Repository();

            List<MEB12_0000> line_code_list = repoMEB12_0000.Get_DataListByAreaCode(sAreaCode);

            if (line_code_list.Count > 0)
            {
                bIsOK = false;
                message += "<div class='text-danger'>";
                message += "<li> " + "此區域向下尚有線別資料!" + " </li>";
                message += "<li> " + "請確認此區域無線別資料後再做刪除!" + " </li>";
                message += "</div>";
            }
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB11_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB11_0000>(new MEB11_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB11_0000", sWhere);
            if (hasRow)
            {
