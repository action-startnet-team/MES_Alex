...
namespace MES_WATER.Controllers
{
    ...
    public class MEB460AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEB460A";
        //需要用到的Repo
        MEB46_0000Repository repoMEB46_0000 = new MEB46_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEB46_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEB46_0000 newData = new MEB46_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEB46_0000 newData = repoMEB46_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB46_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                //repoMEB46_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoMEB46_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB46_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                //執行存檔
                MEB46_0000 data = new MEB46_0000();
                data = repoMEB46_0000.GetDTO(comm.sGetString(form["except_code"]));
                comm.Set_ModelValue(data, form);

                MEB46_0000 sBefore = comm.GetData<MEB46_0000>(data);

                DT.UpdateData("MEB46_0000", "except_code", data);
                //repoMEB46_0000.UpdateData(data);
                ...
                //repoMEB46_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEB46_0000 sBefore = comm.GetData<MEB46_0000>(pTkCode);
            repoMEB46_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB46_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB46_0000>(new MEB46_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB46_0000", sWhere);
            if (hasRow)
            {
