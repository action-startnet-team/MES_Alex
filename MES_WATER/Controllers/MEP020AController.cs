...
namespace MES_WATER.Controllers
{
    ...
    public class MEP020AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEP020A";
        //需要用到的Repo
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEP02_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEP02_0000 newData = new MEP02_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEP02_0000 newData = repoMEP02_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEP02_0000 model)
        {
            // MVC model驗證
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEP02_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEP02_0000 data = new MEP02_0000();
                comm.Set_ModelValue(data, form);
                MEP02_0000 sBefore = comm.GetData<MEP02_0000>(data);
                repoMEP02_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEP02_0000 sBefore = comm.GetData<MEP02_0000>(pTkCode);
            repoMEP02_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEP02_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEP02_0000>(new MEP02_0000());
