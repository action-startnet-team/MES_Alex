...
namespace MES_WATER.Controllers
{
    ...
    public class MED050AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MED050A";
        //需要用到的Repo
        MED05_0000Repository repoMED05_0000 = new MED05_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMED05_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MED05_0000 newData = new MED05_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MED05_0000 newData = repoMED05_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MED05_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMED05_0000.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MED05_0000 model)
        {
            var i = form["is_end"];
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MED05_0000 sBefore = comm.GetData<MED05_0000>(data);
                repoMED05_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MED05_0000 sBefore = comm.GetData<MED05_0000>(pTkCode);
            repoMED05_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MED05_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MED05_0000>(new MED05_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MED05_0000", sWhere);
            if (hasRow)
            {
