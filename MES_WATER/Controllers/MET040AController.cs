...
namespace MES_WATER.Controllers
{
    ...
    public class MET040AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MET040A";
        //需要用到的Repo
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = list.Where(x => x.mo_status == "30" || x.mo_status == "90" || x.mo_status == "60").ToList();
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MET01_0000 newData = new MET01_0000();
