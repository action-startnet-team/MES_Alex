...
namespace MES_WATER.Controllers
{
    ...
    public class ECT020AController : JsonNetController
    {
        //程式代號
        public static string sPrgCode = "ECT020A";
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoECT02_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Get_GridData_D1(string pTkCode)
        {
            ...
            list = repoECT02_0100.Get_DataList(sUsrCode, sPrgCode, pTkCode);
        ...
        //{
        //    ECT02_0000 newData = repoECT02_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, ECT02_0000 model)
        {
            // MVC model驗證
        ...
        public void Insert_D1(FormCollection form)
        {
            ...
            comm.Set_ModelValue(data, form);
            repoECT02_0100.InsertData(data);
        ...
        /// < returns ></ returns >
        [HttpPost]
        public ActionResult Update(FormCollection form, ECT02_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                ECT02_0000 sBefore = comm.GetData<ECT02_0000>(data);
        ...
        public JsonResult Update_D1(FormCollection form)
        {
            ...
            if (result.bIsOK)
            {
                ...
                //Int32 iSorSerial = comm.sGetInt32(comm.Get_Data("ECT02_0100", comm.sGetString(form["stt02_0100"]), "stt02_0100", "sor_serial"));
                //data.sor_serial = iSorSerial;

                ECT02_0100 sBefore = comm.GetData<ECT02_0100>(data);
                repoECT02_0100.UpdateData(data);
                //更新紀錄資料
                comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "update", sBefore, data);
            }
            return Json(result);
        ...
        {
            //刪主檔
            ECT02_0000 sBefore = comm.GetData<ECT02_0000>(pTkCode);
            repoECT02_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        {
            ECT02_0100 sBefore = comm.GetData<ECT02_0100>(pTkCode);
            repoECT02_0100.DeleteData(pTkCode);
            //刪除紀錄資料
            comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "delete", sBefore, "");
        }
        ...
        //主檔的檢查
        //[HttpPost]
        //public ActionResult Check_Data(FormCollection form, ECT02_0000 model)
        //{
        //    bool isSuccess = false;
        //    //檢查資料代碼是否重覆
        //    string key = gmv.GetKey<ECT02_0000>(new ECT02_0000());
        //    string sWhere = "where " + key + "='" + form[key].ToString() + "'";
        //    bool hasRow = !comm.Chk_RelData("ECT02_0000", sWhere);
        //    if (hasRow)
        //    {
        ...
        public ActionResult Chk_Ins_D1(FormCollection form)
        {
            ...
            //重複值檢查
            //if (!comm.Chk_RelData("ECT02_0100", "loc_code", form["loc_code"]))
            //{
            //    bIsOK = false;
            //    message += "<p> 儲位編號重複! </p> ";
            //}
