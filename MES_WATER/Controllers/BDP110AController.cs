...
namespace MES_WATER.Controllers
{
    ...
    public class BDP110AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "BDP110A";

        //需要用到的Repo
        BDP11_0000Repository repoBDP11_0000 = new BDP11_0000Repository();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoBDP11_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            BDP11_0000 newData = new BDP11_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            BDP11_0000 newData = repoBDP11_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, BDP11_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoBDP11_0000.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, BDP11_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                BDP11_0000 data = new BDP11_0000();
                comm.Set_ModelValue(data, form);
                BDP11_0000 sBefore = comm.GetData<BDP11_0000>(data);
                repoBDP11_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            BDP11_0000 sBefore = comm.GetData<BDP11_0000>(pTkCode);
            repoBDP11_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, BDP11_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<BDP11_0000>(new BDP11_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("BDP11_0000", sWhere);
            if (hasRow)
            {
