...
namespace MES_WATER.Controllers
{
    ...
    public class BDP030CController : JsonNetController
    {
        //程式代號
        string sPrgCode = "BDP030C";
        //需要用到的Repo
        BDP30_0200Repository repoBDP30_0200 = new BDP30_0200Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoBDP30_0200.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            BDP30_0200 newData = new BDP30_0200();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            BDP30_0200 newData = repoBDP30_0200.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, BDP30_0200 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoBDP30_0200.InsertData(data);
                ...
                //repoBDP30_0200.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, BDP30_0200 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                BDP30_0200 data = new BDP30_0200();
                comm.Set_ModelValue(data, form);
                repoBDP30_0200.UpdateData(data);
                return RedirectToAction("Index");
                ...
                //repoBDP30_0200.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            repoBDP30_0200.DeleteData(pTkCode);
            return RedirectToAction("Index");
        }
        /* 資料處理 向上 */
        ...
        {
            string sReturn = "";
            sReturn = comm.Get_QueryData("BDP030C", pProCode, "bdp30_0200", pType);
            return sReturn;
        }
    }
}