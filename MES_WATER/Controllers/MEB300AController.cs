...
namespace MES_WATER.Controllers
{
    ...
    public class MEB300AController : JsonNetController
    {
        //程式代號
        public static string sPrgCode = "MEB300A";

        //需要用到的Repo
        MEB30_0000Repository repoMEB30_0000 = new MEB30_0000Repository();
        MEB30_0100Repository repoMEB30_0100 = new MEB30_0100Repository();
        ...
        public ActionResult Get_GridData_D1(string pTkCode)
        {
            ...
            list = repoMEB30_0100.Get_DataList(sUsrCode, sPrgCode, pTkCode);
        ...
        public ActionResult Get_GridData_D2(string pTkCode)
        {
            ...
            List<MEB30_0200> list = repoMEB30_0200.Get_DataList(sUsrCode, sPrgCode, "work_code", pTkCode);

            return Json(list, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public ActionResult Get_GridData_D3(string pTkCode)
        {
            string sUsrCode = User.Identity.Name;

            List<MEB30_0300> list = repoMEB30_0300.Get_DataList(sUsrCode, sPrgCode, "work_code", pTkCode);
        ...
        {
            MEB30_0000 newData = repoMEB30_0000.GetDTO(pTkCode);
            //ViewBag.SorType = comm.Get_Data("MEB30_0000", pTkCode, "sto_code", "sor_type");
            return View(newData);
        }
        ...
        public ActionResult Update3(string pTkCode)
        {
            MEB30_0000 newData = repoMEB30_0000.GetDTO(pTkCode);
            //ViewBag.SorType = comm.Get_Data("MEB30_0000", pTkCode, "sto_code", "sor_type");
            return View(newData);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB30_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB30_0000.InsertData(data);
                // 新增紀錄資料
                comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "insert", "", data);
                return RedirectToAction("Update", sPrgCode, new { pTkCode = data.work_code });
            }
            ViewBag.showErrMsg = true;
            return View(model);
        }
        ...
        public void Insert_D1(FormCollection form)
        {
            ...
            repoMEB30_0100.InsertData(data);
            // 新增紀錄資料
            comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "insert", "", data);
        }

        [HttpPost]
        public void Insert_D2(FormCollection form)
        {
        ...
        [HttpPost]
        public void Insert_D3(FormCollection form)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB30_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                MEB30_0000 sBefore = comm.GetData<MEB30_0000>(data);
                repoMEB30_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public JsonResult Update_D1(FormCollection form)
        {
            ...
            if (result.bIsOK)
            {
                ...
                //Int32 iSorSerial = comm.sGetInt32(comm.Get_Data("MEB30_0100", comm.sGetString(form["stt02_0100"]), "stt02_0100", "sor_serial"));
                //data.sor_serial = iSorSerial;

                MEB30_0100 sBefore = comm.GetData<MEB30_0100>(data);
                repoMEB30_0100.UpdateData(data);
                //更新紀錄資料
                comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "update", sBefore, data);
        ...
        [HttpPost]
        public JsonResult Update_D2(FormCollection form)
        {
            CheckDataResult result = Chk_Upd_D2(form);
            if (result.bIsOK)
            {
                MEB30_0200 data = new MEB30_0200();
                ...
                MEB30_0200 sBefore = comm.GetData<MEB30_0200>(data);
                repoMEB30_0200.UpdateData(data);
                //更新紀錄資料
                comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "update", sBefore, data);
        ...
        [HttpPost]
        public JsonResult Update_D3(FormCollection form)
        {
            CheckDataResult result = Chk_Upd_D3(form);
            if (result.bIsOK)
            {
                MEB30_0300 data = new MEB30_0300();
                ...
                MEB30_0300 sBefore = comm.GetData<MEB30_0300>(data);
                repoMEB30_0300.UpdateData(data);
                //更新紀錄資料
                comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "update", sBefore, data);
        ...
        {
            //刪主檔
            MEB30_0000 sBefore = comm.GetData<MEB30_0000>(pTkCode);
            repoMEB30_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        {
            MEB30_0100 sBefore = comm.GetData<MEB30_0100>(pTkCode);
            repoMEB30_0100.DeleteData(pTkCode);
            //刪除紀錄資料
            comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "delete", sBefore, "");
        }

        [HttpPost]
        public void Delete_D2(String pTkCode)
        {
            MEB30_0200 sBefore = comm.GetData<MEB30_0200>(pTkCode);
            repoMEB30_0200.DeleteData(pTkCode);
            //刪除紀錄資料
            comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "delete", sBefore, "");
        ...
        [HttpPost]
        public void Delete_D3(String pTkCode)
        {
            MEB30_0300 sBefore = comm.GetData<MEB30_0300>(pTkCode);
            repoMEB30_0300.DeleteData(pTkCode);
            //刪除紀錄資料
            comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "delete", sBefore, "");
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB30_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB30_0000>(new MEB30_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB30_0000", sWhere);
            if (hasRow)
            {
        ...
        public ActionResult Chk_Ins_D1(FormCollection form)
        {
            ...
            //重複值檢查
            if (!comm.Chk_RelData("MEB30_0100", "meb30_0100", form["meb30_0100"]))
            {
                bIsOK = false;
                message += "<p> 編號重複! </p> ";
            }
        ...
        [HttpPost]
        public ActionResult Chk_Ins_D2(FormCollection form)
        {
            bool bIsOK = true;
            string message = "";

            //重複值檢查
            if (!comm.Chk_RelData("MEB30_0200", "meb30_0200", form["meb30_0200"]))
            {
                bIsOK = false;
                message += "<p> 編號重複! </p> ";
            }
        ...
        [HttpPost]
        public ActionResult Chk_Ins_D3(FormCollection form)
        {
            bool bIsOK = true;
            string message = "";

            //重複值檢查
            if (!comm.Chk_RelData("MEB30_0300", "meb30_0300", form["meb30_0300"]))
            {
                bIsOK = false;
                message += "<p> 編號重複! </p> ";
            }
        ...
        [HttpPost]
        public JsonResult Chk_Del_D2(FormCollection form)
        {
            bool bIsOK = true;
            string message = "";
        ...
        [HttpPost]
        public JsonResult Chk_Del_D3(FormCollection form)
        {
            bool bIsOK = true;
            string message = "";
        ...
        public CheckDataResult Chk_Upd_D2(FormCollection form)
        {
            CheckDataResult result = new CheckDataResult();
            //** 依作業不同有不同的檢查點 向下
            //if (comm.sGetInt32(form["pro_price"]) == 0)
        ...
        public CheckDataResult Chk_Upd_D3(FormCollection form)
        {
            CheckDataResult result = new CheckDataResult();
            //** 依作業不同有不同的檢查點 向下
            //if (comm.sGetInt32(form["pro_price"]) == 0)
        ...
        public DataTable Get_QmtValue_DataTable()
        {
            string sSql = "";
        ...
        public string Get_QmtValue()
        {
            DataTable dtTmp = Get_QmtValue_DataTable();
