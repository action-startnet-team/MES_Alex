...
namespace MES_WATER.Controllers
{
    ...
    public class MEB120AController : JsonNetController
    {
        //程式代號
        public static string sPrgCode = "MEB120A";

        //需要用到的Repo
        MEB12_0000Repository repoMEB12_0000 = new MEB12_0000Repository();
        MEB12_0100Repository repoMEB12_0100 = new MEB12_0100Repository();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEB12_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Get_GridData_D1(string pTkCode)
        {
            ...
            list = repoMEB12_0100.Get_DataList(sUsrCode, sPrgCode, pTkCode);
        ...
        {
            MEB12_0000 newData = repoMEB12_0000.GetDTO(pTkCode);
            //newData.factory_code = comm.Get_QueryData("MEB11_0000", newData.area_code, "area_code", "factory_code");
            return View(newData);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB12_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB12_0000.InsertData(data);
        ...
        public void Insert_D1(FormCollection form)
        {
            ...
            repoMEB12_0100.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB12_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                MEB12_0000 sBefore = comm.GetData<MEB12_0000>(data);
                repoMEB12_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public JsonResult Update_D1(FormCollection form)
        {
            ...
            if (result.bIsOK)
            {
                ...
                //Int32 iSorSerial = comm.sGetInt32(comm.Get_Data("MEB12_0100", comm.sGetString(form["stt02_0100"]), "stt02_0100", "sor_serial"));
                //data.sor_serial = iSorSerial;

                MEB12_0100 sBefore = comm.GetData<MEB12_0100>(data);
                repoMEB12_0100.UpdateData(data);
                //更新紀錄資料
                comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "update", sBefore, data);
            }
            return Json(result);
        ...
        /// <returns></returns>
        public JsonResult Get_ProCode(string pTkCode)
        {
            ...
            string sSql = "select top 10000 pro_code as field_code, pro_name as field_name " +
                          " from MEB20_0000 " +
                          " where pro_code like @pro_code ";
            using (SqlConnection conn = comm.Set_DBConnection())
            {
                list = conn.Query<DDLList>(sSql, new { pro_code = pTkCode + "%" }).ToList();
            }
        ...
        {
            //刪主檔
            MEB12_0000 sBefore = comm.GetData<MEB12_0000>(pTkCode);
            repoMEB12_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        {
            MEB12_0100 sBefore = comm.GetData<MEB12_0100>(pTkCode);
            repoMEB12_0100.DeleteData(pTkCode);
            //刪除紀錄資料
            comm.Ins_BDP20_0000ForMdy(User.Identity.Name, sPrgCode, "delete", sBefore, "");
        }
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB12_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB12_0000>(new MEB12_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB12_0000", sWhere);
            if (hasRow)
            {
        ...
        public ActionResult Chk_Ins_D1(FormCollection form)
        {
            ...
            //重複值檢查
            //if (!comm.Chk_RelData("MEB12_0100", "loc_code", form["loc_code"]))
            //{
            //    bIsOK = false;
            //    message += "<p> 儲位編號重複! </p> ";
            //}
        ...
        public JsonResult Get_AreaCode(string factory_code)
        {
            string sSql = "select MEB11_0000.* from MEB11_0000 where factory_code = @factory_code ";
            DataTable dtTmp = comm.Get_DataTable(sSql, "factory_code", factory_code);
