...
namespace MES_WATER.Controllers
{
    ...
    public class BDP310AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "BDP310A";
        //需要用到的Repo
        BDP31_0000Repository repoBDP31_0000 = new BDP31_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoBDP31_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            BDP31_0000 newData = new BDP31_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            BDP31_0000 newData = repoBDP31_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, BDP31_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                //執行存檔
                BDP31_0000 data = new BDP31_0000();
                ...
                repoBDP31_0000.InsertData(data);
                // 紀錄資料
                ...
                //repoBDP31_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, BDP31_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                BDP31_0000 data = new BDP31_0000();
                comm.Set_ModelValue(data, form);
                BDP31_0000 sBefore = comm.GetData<BDP31_0000>(data);
                repoBDP31_0000.UpdateData(data);
                // 紀錄資料
                ...
                //repoBDP31_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            BDP31_0000 sBefore = comm.GetData<BDP31_0000>(pTkCode);
            repoBDP31_0000.DeleteData(pTkCode);
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, BDP31_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<BDP31_0000>(new BDP31_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("BDP31_0000", sWhere);
            if (hasRow)
            {
