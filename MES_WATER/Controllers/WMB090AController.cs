...
namespace MES_WATER.Controllers
{
    ...
    public class WMB090AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "WMB090A";
        //需要用到的Repo
        WMB09_0000Repository repoWMB09_0000 = new WMB09_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoWMB09_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            WMB09_0000 newData = new WMB09_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            WMB09_0000 newData = repoWMB09_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, WMB09_0000 model)
        {
            // MVC model驗證
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, WMB09_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                WMB09_0000 data = new WMB09_0000();
                comm.Set_ModelValue(data, form);
                WMB09_0000 sBefore = comm.GetData<WMB09_0000>(data);
                repoWMB09_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            WMB09_0000 sBefore = comm.GetData<WMB09_0000>(pTkCode);
            repoWMB09_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, WMB09_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<WMB09_0000>(new WMB09_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("WMB09_0000", sWhere);
            if (hasRow)
            {
