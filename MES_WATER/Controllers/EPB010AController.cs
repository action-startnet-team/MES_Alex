...
namespace MES_WATER.Controllers
{
    ...
    public class EPB010AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "EPB010A";
        //需要用到的Repo
        EPB01_0000Repository repoEPB01_0000 = new EPB01_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoEPB01_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            EPB01_0000 newData = new EPB01_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            EPB01_0000 newData = repoEPB01_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, EPB01_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoEPB01_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoEPB01_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, EPB01_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                EPB01_0000 data = new EPB01_0000();
                comm.Set_ModelValue(data, form);
                EPB01_0000 sBefore = comm.GetData<EPB01_0000>(data);
                repoEPB01_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoEPB01_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            EPB01_0000 sBefore = comm.GetData<EPB01_0000>(pTkCode);
            repoEPB01_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, EPB01_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<EPB01_0000>(new EPB01_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("EPB01_0000", sWhere);
            if (hasRow)
            {
