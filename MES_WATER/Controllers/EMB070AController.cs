...
namespace MES_WATER.Controllers
{
    ...
    public class EMB070AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "EMB070A";
        //需要用到的Repo
        EMB07_0000Repository repoEMB07_0000 = new EMB07_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoEMB07_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            EMB07_0000 newData = new EMB07_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            EMB07_0000 newData = repoEMB07_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, EMB07_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoEMB07_0000.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, EMB07_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                EMB07_0000 sBefore = comm.GetData<EMB07_0000>(data);
                repoEMB07_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            EMB07_0000 sBefore = comm.GetData<EMB07_0000>(pTkCode);
            repoEMB07_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, EMB07_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<EMB07_0000>(new EMB07_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("EMB07_0000", sWhere);
            if (hasRow)
            {
