...
namespace MES_WATER.Controllers
{
    ...
    public class WMR030AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "WMR030A";
        //需要用到的Repo
        WMB03_0000Repository repoWMB03_0000 = new WMB03_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        GetModelValidation gmv = new GetModelValidation();
        public class WMR030A
        {
            [DisplayName("json")]
        ...
        public void InsertData(WMR030A data)
        {
        ...
        [HttpPost]
        public ActionResult Index(FormCollection form, WMR030A WMR030A)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //執行存檔
                WMR030A data = new WMR030A();
                comm.Set_ModelValue(data, form);
                data.ins_date = comm.Get_Date();
                data.ins_time = comm.Get_Time();
                //data.json = JsonConvert.SerializeObject(new List<WMR030A>() { data });
