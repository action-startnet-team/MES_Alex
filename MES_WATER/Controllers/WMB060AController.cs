...
namespace MES_WATER.Controllers
{
    ...
    public class WMB060AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "WMB060A";
        //需要用到的Repo
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoWMB06_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            WMB06_0000 newData = new WMB06_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            WMB06_0000 newData = repoWMB06_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, WMB06_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoWMB06_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoWMB06_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, WMB06_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                WMB06_0000 sBefore = comm.GetData<WMB06_0000>(data);
                repoWMB06_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoWMB06_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            WMB06_0000 sBefore = comm.GetData<WMB06_0000>(pTkCode);
            repoWMB06_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, WMB06_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<WMB06_0000>(new WMB06_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("WMB06_0000", sWhere);
            if (hasRow)
            {
