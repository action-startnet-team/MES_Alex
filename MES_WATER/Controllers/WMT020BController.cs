...
namespace MES_WATER.Controllers
{
    ...
    public class WMT020BController : JsonNetController
    {
        //程式代號
        string sPrgCode = "WMT020B";
        //需要用到的Repo
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoWMT0200.Get_DataListByQuery4(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert(FormCollection form, WMT0200 model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //repoWMT0200.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Update(FormCollection form, WMT0200 model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //repoWMT0200.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
