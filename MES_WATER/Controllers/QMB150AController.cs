...
namespace MES_WATER.Controllers
{
    ...
    public class QMB150AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "QMB150A";
        //需要用到的Repo
        QMB15_0000Repository repoQMB15_0000 = new QMB15_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoQMB15_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            QMB15_0000 newData = new QMB15_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            QMB15_0000 newData = repoQMB15_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, QMB15_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoQMB15_0000.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, QMB15_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                QMB15_0000 sBefore = comm.GetData<QMB15_0000>(data);
                repoQMB15_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            QMB15_0000 sBefore = comm.GetData<QMB15_0000>(pTkCode);
            repoQMB15_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, QMB15_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<QMB15_0000>(new QMB15_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("QMB15_0000", sWhere);
            if (hasRow)
            {
