...
namespace MES_WATER.Controllers
{
    ...
    public class EMT010BController : JsonNetController
    {
        //程式代號
        string sPrgCode = "EMT010B";
        //需要用到的Repo
        EMT01_0100BRepository repoEMT01_0100B = new EMT01_0100BRepository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoEMT01_0100B.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            EMT01_0100B newData = new EMT01_0100B();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            EMT01_0100B newData = repoEMT01_0100B.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, EMT01_0100B model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                repoEMT01_0100B.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, EMT01_0100B model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                EMT01_0100B data = new EMT01_0100B();
                comm.Set_ModelValue(data, form);
                EMT01_0100B sBefore = comm.GetData<EMT01_0100B>(data);
                repoEMT01_0100B.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            EMT01_0100B sBefore = comm.GetData<EMT01_0100B>(pTkCode);
            repoEMT01_0100B.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, EMT01_0100B model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<EMT01_0100B>(new EMT01_0100B());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("EMT01_0100", sWhere);
            if (hasRow)
            {
