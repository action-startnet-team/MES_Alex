...
namespace MES_WATER.Controllers
{
    ...
    public class MED030AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MED030A";
        //需要用到的Repo
        MED03_0000Repository repoMED03_0000 = new MED03_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMED03_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MED03_0000 newData = new MED03_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MED03_0000 newData = repoMED03_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MED03_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMED03_0000.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MED03_0000 model)
        {
            var i = form["is_end"];
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MED03_0000 sBefore = comm.GetData<MED03_0000>(data);
                repoMED03_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MED03_0000 sBefore = comm.GetData<MED03_0000>(pTkCode);
            repoMED03_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MED03_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MED03_0000>(new MED03_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MED03_0000", sWhere);
            if (hasRow)
            {
