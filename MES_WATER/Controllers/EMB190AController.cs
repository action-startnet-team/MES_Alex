...
namespace MES_WATER.Controllers
{
    ...
    public class EMB190AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "EMB190A";
        //需要用到的Repo
        EMB19_0000Repository repoEMB19_0000 = new EMB19_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoEMB19_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            EMB19_0000 newData = new EMB19_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            EMB19_0000 newData = repoEMB19_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, EMB19_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoEMB19_0000.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, EMB19_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                EMB19_0000 sBefore = comm.GetData<EMB19_0000>(data);
                repoEMB19_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            EMB19_0000 sBefore = comm.GetData<EMB19_0000>(pTkCode);
            repoEMB19_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, EMB19_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<EMB19_0000>(new EMB19_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("EMB19_0000", sWhere);
            if (hasRow)
            {
