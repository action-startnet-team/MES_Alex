...
namespace MES_WATER.Controllers
{
    ...
    public class WMR060AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "WMR060A";
        //需要用到的Repo
        ...
        public void InsertData(WMR060A data)
        {
        ...
        [HttpPost]
        public ActionResult Index(FormCollection form, WMR060A WMR060A)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //執行存檔
                WMR060A data = new WMR060A();
                comm.Set_ModelValue(data, form);
                data.ins_date = comm.Get_Date();
                data.ins_time = comm.Get_Time();
                //data.json = JsonConvert.SerializeObject(new List<WMR060A>() { data });
