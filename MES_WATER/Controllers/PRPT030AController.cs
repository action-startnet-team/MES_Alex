...
{
    public class PRPT030AController : Controller
    {
        // 共用函數庫
        Comm comm = new Comm();
        ...
        {
            // 報表欄位結構
            List<PRPT030A> result = new List<PRPT030A>();
        ...
        public List<PRPT030A> Get_StatData(JqGridQueryData query_data)
        {
            List<PRPT030A> result = new List<PRPT030A>();
