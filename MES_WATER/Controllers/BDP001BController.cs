...
{
    public class BDP001BController : Controller
    {
            ...
            if (form["submit"] == "save")
            {
                if (form["limit_type"] != "" & form["limit_type"] != null)
                    if (form["usr_code"] != "" & form["usr_code"] != null || form["grp_code"] != "" & form["grp_code"] != null)
                    {
                        ...
                        //所有作業
                        sSql = "select * from BDP04_0000 where is_use = 'Y'";
