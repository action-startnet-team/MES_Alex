...
namespace MES_WATER.Controllers
{
    public class LoginController : Controller
    {
        ...
        {
            //if (!Chk_IsMobile()) { return RedirectToAction("Index2"); }
            ...
            //ViewBag.prj_name = comm.Get_QueryData("BDP00_0000", "prj_name", "par_name", "par_value");
            //ViewBag.com_name = comm.Get_QueryData("BDP00_0000", "com_name", "par_name", "par_value");
            ViewBag.WebLogin = comm.Get_QueryData("BDP00_0000", "WebLogin", "par_name", "par_value");
            //ViewBag.Message = tk_code;
            //return View();
            if (ViewBag.WebLogin == "") return RedirectToAction("Index2");

            return RedirectToAction(ViewBag.WebLogin);
        }
        ...
        public ActionResult Index(FormCollection post)
        {
            ...
            if (comm.Chk_Login(usr_code,usr_pass))
            {
                ...
                return RedirectToAction("Index", "MET030A", null);
        ...
        public ActionResult Index2(string usr_code, string usr_pass)
        {
            // 使用者已經驗證
        ...
        [HttpPost]
        public ActionResult Index2(FormCollection post)
        {
            //var obj = Server.CreateObject("Snfun1.dll");
        ...
        public ActionResult Index3(string usr_code, string usr_pass)
        {
            //ViewBag.prj_name = comm.Get_QueryData("BDP00_0000", "prj_name", "par_name", "par_value");
            //ViewBag.com_name = comm.Get_QueryData("BDP00_0000", "com_name", "par_name", "par_value");
            //ViewBag.Message = tk_code;
        ...
        [HttpPost]
        public ActionResult Index3(FormCollection post)
        {
            //var obj = Server.CreateObject("Snfun1.dll");
        ...
        public ActionResult Index_Alex(string usr_code, string usr_pass)
        {
            ViewBag.prj_name = comm.Get_QueryData("BDP00_0000", "prj_name", "par_name", "par_value");
            ViewBag.com_name = comm.Get_QueryData("BDP00_0000", "com_name", "par_name", "par_value");
            //ViewBag.Message = tk_code;
        ...
        [HttpPost]
        public ActionResult Index_Alex(FormCollection post)
        {
            //var obj = Server.CreateObject("Snfun1.dll");
        ...
        {
            if (string.IsNullOrEmpty(User.Identity.Name)) { return RedirectToAction("Index", "LoginTimeOut"); }

            comm.Upd_QueryData("BDP08_0000", "usr_code", User.Identity.Name, "usr_pass",form["new_password"]);                
            return RedirectToAction("Index");
        }

        public string Chk_PassWord(string pValue) {
            string sValue = "";
            string sOldPassWord = comm.Get_QueryData("BDP08_0000", User.Identity.Name, "usr_code", "usr_pass");
            if (pValue != sOldPassWord) {
                sValue = "輸入的舊密碼錯誤"; 
            }
            return sValue;
        }
