...
namespace MES_WATER.Controllers
{
    ...
    public class DSB220AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "DSB220A";
        ...
        public ActionResult GetData(string query_date_s, string query_date_e, string mac_code)
        {
            ...
            string sSql = @" select *  from (select TOP 30 * From MEA_E03";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    date = Convert.ToDateTime(dt.Rows[j]["update_at"]).ToString("HH:mm:ss");
                    qty = dt.Rows[j]["300130"].ToString();
                    j++;
                }
        ...
        public ActionResult GetData_2(string query_date_s, string query_date_e, string mac_code)
        {
        ...
        public ActionResult GetData_3(string query_date_s, string query_date_e, string mac_code)
        {
        ...
        public ActionResult GetData_4(string query_date_s, string query_date_e, string mac_code)
        {
        ...
        public ActionResult GetData_5(string query_date_s, string query_date_e, string mac_code)
        {
        ...
        public ActionResult GetData_6(string query_date_s, string query_date_e, string mac_code)
        {
        ...
        public ActionResult GetData_7(string query_date_s, string query_date_e, string mac_code)
        {
