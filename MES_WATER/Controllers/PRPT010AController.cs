...
{
    public class PRPT010AController : Controller
    {
        // 共用函數庫
        Comm comm = new Comm();
        ...
        {
            // 報表欄位結構
            List<PRPT010A> result = new List<PRPT010A>();
        ...
        public List<PRPT010A> Get_StatData(JqGridQueryData query_data)
        {
            List<PRPT010A> result = new List<PRPT010A>();
