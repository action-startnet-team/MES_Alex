...
namespace MES_WATER.Controllers
{
    ...
    public class MEP060AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEP060A";
        //需要用到的Repo
        MEP06_0000Repository repoMEP06_0000 = new MEP06_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEP06_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEP06_0000 newData = new MEP06_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEP06_0000 newData = repoMEP06_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEP06_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEP06_0000.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEP06_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEP06_0000 data = new MEP06_0000();
                comm.Set_ModelValue(data, form);
                MEP06_0000 sBefore = comm.GetData<MEP06_0000>(data);
                repoMEP06_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEP06_0000 sBefore = comm.GetData<MEP06_0000>(pTkCode);
            repoMEP06_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEP06_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEP06_0000>(new MEP06_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEP06_0000", sWhere);
            if (hasRow)
            {
