...
namespace MES_WATER.Controllers
{
    ...
    public class MEB140AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEB140A";
        //需要用到的Repo
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEB14_0000 newData = new MEB14_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEB14_0000 newData = repoMEB14_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB14_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB14_0000.InsertData(data);
                // 新增紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB14_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEB14_0000 data = new MEB14_0000();
                comm.Set_ModelValue(data, form);
                MEB14_0000 sBefore = comm.GetData<MEB14_0000>(data);
                repoMEB14_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEB14_0000 sBefore = comm.GetData<MEB14_0000>(pTkCode);
            repoMEB14_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB14_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB14_0000>(new MEB14_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB14_0000", sWhere);
            if (hasRow)
            {
