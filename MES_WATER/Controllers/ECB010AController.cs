...
namespace MES_WATER.Controllers
{
    ...
    public class ECB010AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "ECB010A";
        //需要用到的Repo
        ECB01_0000Repository repoECB01_0000 = new ECB01_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoECB01_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);

            return Json(list, JsonRequestBehavior.AllowGet);
        }

        public ActionResult GetCusData()
        {
            repoECB01_0000.DeleteData2();
            repoECB01_0000.InsertOriData();
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            ECB01_0000 newData = new ECB01_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            ECB01_0000 newData = repoECB01_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, ECB01_0000 model)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, ECB01_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                ECB01_0000 data = new ECB01_0000();
                comm.Set_ModelValue(data, form);
                ECB01_0000 sBefore = comm.GetData<ECB01_0000>(data);
                repoECB01_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            ECB01_0000 sBefore = comm.GetData<ECB01_0000>(pTkCode);
            repoECB01_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, ECB01_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<ECB01_0000>(new ECB01_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("ECB01_0000", sWhere);
            if (hasRow)
            {
