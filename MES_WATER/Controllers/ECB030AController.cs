...
namespace MES_WATER.Controllers
{
    ...
    public class ECB030AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "ECB030A";
        //需要用到的Repo
        ECB03_0000Repository repoECB03_0000 = new ECB03_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoECB03_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            ECB03_0000 newData = new ECB03_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            ECB03_0000 newData = repoECB03_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, ECB03_0000 model)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, ECB03_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                ECB03_0000 data = new ECB03_0000();
                comm.Set_ModelValue(data, form);
                ECB03_0000 sBefore = comm.GetData<ECB03_0000>(data);
                repoECB03_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            ECB03_0000 sBefore = comm.GetData<ECB03_0000>(pTkCode);
            repoECB03_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, ECB03_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<ECB03_0000>(new ECB03_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("ECB03_0000", sWhere);
            if (hasRow)
            {
