...
{
    public class RPT250AController : Controller
    {
        // 共用函數庫
        Comm comm = new Comm();
        ...
        {
            // 報表欄位結構
            List<RPT250A> result = new List<RPT250A>();
        ...
        public List<RPT250A> Get_StatData(JqGridQueryData query_data)
        {
            List<RPT250A> result = new List<RPT250A>();
            ...
            comm.Ins_BDP20_0000("admin", "RPT250A", "RPT", sSql);


            for (i = 0; i < dtTmp.Rows.Count; i++)
            {
                RPT250A data = new RPT250A();
