...
namespace MES_WATER.Controllers
{
    ...
    public class MEB450AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEB450A";
        //需要用到的Repo
        MEB45_0000Repository repoMEB45_0000 = new MEB45_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEB45_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEB45_0000 newData = new MEB45_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEB45_0000 newData = repoMEB45_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEB45_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEB45_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoMEB45_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEB45_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEB45_0000 data = new MEB45_0000();
                comm.Set_ModelValue(data, form);
                MEB45_0000 sBefore = comm.GetData<MEB45_0000>(data);
                repoMEB45_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoMEB45_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEB45_0000 sBefore = comm.GetData<MEB45_0000>(pTkCode);
            repoMEB45_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEB45_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEB45_0000>(new MEB45_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEB45_0000", sWhere);
            if (hasRow)
            {
