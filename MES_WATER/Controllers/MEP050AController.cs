...
namespace MES_WATER.Controllers
{
    ...
    public class MEP050AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "MEP050A";
        //需要用到的Repo
        MEP05_0000Repository repoMEP05_0000 = new MEP05_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoMEP05_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            MEP05_0000 newData = new MEP05_0000();
            return View(newData);
        }
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            MEP05_0000 newData = repoMEP05_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, MEP05_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoMEP05_0000.InsertData(data);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, MEP05_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                MEP05_0000 data = new MEP05_0000();
                comm.Set_ModelValue(data, form);
                MEP05_0000 sBefore = comm.GetData<MEP05_0000>(data);
                repoMEP05_0000.UpdateData(data);
                //更新紀錄資料
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            MEP05_0000 sBefore = comm.GetData<MEP05_0000>(pTkCode);
            repoMEP05_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, MEP05_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<MEP05_0000>(new MEP05_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("MEP05_0000", sWhere);
            if (hasRow)
            {
