...
namespace MES_WATER.Controllers
{
    ...
    public class EMB020AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "EMB020A";
        //需要用到的Repo
        EMB02_0000Repository repoEMB02_0000 = new EMB02_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoEMB02_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            EMB02_0000 newData = new EMB02_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            EMB02_0000 newData = repoEMB02_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, EMB02_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoEMB02_0000.InsertData(data);
                // 新增紀錄資料
                ...
                //repoEMB02_0000.InsertData(newData);
                //ViewBag.prg_code = sPrgCode;
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, EMB02_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                EMB02_0000 sBefore = comm.GetData<EMB02_0000>(data);
                repoEMB02_0000.UpdateData(data);
                //更新紀錄資料
                ...
                //repoEMB02_0000.UpdateData(newData);
                //return RedirectToAction("Index");
            }
            ViewBag.showErrMsg = true;
            ViewBag.prg_code = sPrgCode;
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            EMB02_0000 sBefore = comm.GetData<EMB02_0000>(pTkCode);
            repoEMB02_0000.DeleteData(pTkCode);
            //刪除紀錄資料
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, EMB02_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<EMB02_0000>(new EMB02_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("EMB02_0000", sWhere);
            if (hasRow)
            {
