...
namespace MES_WATER.Controllers
{
    ...
    public class BDP030AController : JsonNetController
    {
        //程式代號
        string sPrgCode = "BDP030A";
        //需要用到的Repo
        BDP03_0000Repository repoBDP03_0000 = new BDP03_0000Repository();
        //共用函式庫
        Comm comm = new Comm();
        ...
        public ActionResult Get_GridDataByQuery(string pWhere)
        {
            ...
            list = repoBDP03_0000.Get_DataListByQuery(sUsrCode, sPrgCode, pWhere);
        ...
        public ActionResult Insert()
        {
            ...
            //新增模式的預設值
            BDP03_0000 newData = new BDP03_0000();
        ...
        public ActionResult Update(string pTkCode)
        {
            ...
            BDP03_0000 newData = repoBDP03_0000.GetDTO(pTkCode);
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Insert(FormCollection form, BDP03_0000 model)
        {
            // MVC model驗證
            if (ModelState.IsValid)
            {
                ...
                repoBDP03_0000.InsertData(data);
                // 紀錄資料
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Update(FormCollection form, BDP03_0000 model)
        {
            // MVC model驗證 資料格式檢查
            if (ModelState.IsValid)
            {
                ...
                BDP03_0000 sBefore = comm.GetData<BDP03_0000>(data);

                repoBDP03_0000.UpdateData(data);
        ...
        public ActionResult Delete(string pTkCode)
        {
            ...
            BDP03_0000 sBefore = comm.GetData<BDP03_0000>(pTkCode);
            repoBDP03_0000.DeleteData(pTkCode);
        ...
        //主檔的檢查
        [HttpPost]
        public ActionResult Check_Data(FormCollection form, BDP03_0000 model)
        {
            bool isSuccess = false;
            //檢查資料代碼是否重覆
            string key = gmv.GetKey<BDP03_0000>(new BDP03_0000());
            string sWhere = "where " + key + "='" + form[key].ToString() + "'";
            bool hasRow = !comm.Chk_RelData("BDP03_0000", sWhere);
            if (hasRow)
            {
