...
{
    public class MET04_0400Repository
    {
        Comm comm = new Comm();
        ...
        //// < returns > DTO MET04_0400</returns>
        public MET04_0400 GetDTO(string pTkCode)
        {
            MET04_0400 datas = new MET04_0400();
            string sSql = "";

            if (string.IsNullOrEmpty(pTkCode))
            {
                sSql = "SELECT * FROM MET04_0400";
            }
            else
            {
                sSql = "SELECT * FROM MET04_0400 where ureport_code=@ureport_code";
            }
        ...
        //// </summary>
        //// <param name = "pTkCode" > 鍵值 / 傳空值取全部資料 </ param >
        //// < returns > List MET04_0400</returns>
        public List<MET04_0400> Get_DataList(string pTkCode)
        {
            List<MET04_0400> list = new List<MET04_0400>();
            string sSql = "";
            ...
            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                ...
                while (reader.Read())
                {
                    MET04_0400 data = new MET04_0400();
        ...
        //// <returns></returns>
        public List<MET04_0400> Get_DataList(string pUsrCode, string pPrgCode)
        {
        ...
        /// <returns></returns>
        public List<MET04_0400> Get_DataListByQuery(string pUsrCode, string pPrgCode, string pWhere)
        {
            List<MET04_0400> list = new List<MET04_0400>();

            string sSql = " SELECT MET04_0400.*, MEB15_0000.mac_name as mac_name , BDP08_0000.usr_name as usr_name" +
                                " FROM MET04_0400" +
                                " left join MEB15_0000 on MEB15_0000.mac_code = MET04_0400.mac_code " +
                                " left join BDP08_0000 on BDP08_0000.usr_code = MET04_0400.usr_code ";

            // 取得資料
            list = comm.Get_ListByQuery<MET04_0400>(sSql, pWhere, pUsrCode, pPrgCode);
        ...
        /// <summary>
        /// 傳入一個MET04_0400的DTO，存檔，一次存檔一筆
        /// </summary>
        /// <param name = "MET04_0400" > DTO </ param >
        public void InsertData(MET04_0400 MET04_0400)
        {
            string sSql = "INSERT INTO " +
                          " MET04_0400 (     ureport_code,   ureport_date,    mo_code,    mac_code,    usr_code,    wrk_date_s , " +
                          "                           wrk_time_s,   wrk_date_e,    wrk_time_e,    sub_minute,    sub_hour     ) " +
                          "     VALUES     (  @ureport_code, @ureport_date, @mo_code, @mac_code, @usr_code, @wrk_date_s, "+
                          "                       @wrk_time_s,     @wrk_date_e,    @wrk_time_e,    @sub_minute,    @sub_hour ) " ;
            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                con_db.Execute(sSql, MET04_0400);
            }
        }

        /// <summary>
        /// 傳入一個MET04_0400的DTO，修改，一次修改一筆
        /// </summary>
        /// <param name = "MET04_0400" > DTO </ param >
        public void UpdateData(MET04_0400 MET04_0400)
        {

            string sSql = " UPDATE MET04_0400                     " +
        ...
        {
            string sSql = "DELETE FROM MET04_0400 WHERE ureport_code = @ureport_code;";
            using (SqlConnection con_db = comm.Set_DBConnection())
            {
        ...
        ////暫存DataTable參考
        ////<summary>
        ////取得MET04_0400角色的DataTable
        ////</summary>
        ////<param name="pTkCode">有傳鍵值取一筆，鍵值空白取全部</param>
        ////<returns></returns>
        //public DataTable GetMET04_0400_dt(string pTkCode)
        //{
        ...
        //    else
        //    {
        //        sSql = "SELECT * FROM MET04_0400 where ureport_code='" + pTkCode + "'";
        //    }
