...
{
    public class RPT24_0000Repository
    {
        Comm comm = new Comm();
        ...
        /// </summary>
        /// <param name="RPT24_0000">DTO</param>
        public void InsertData(RPT24_0000 RPT24_0000)
        {
            ...
            {
                con_db.Execute(sSql, RPT24_0000);
            }
        }
        ...
        /// </summary>
        /// <param name="RPT24_0000">DTO</param>
        public void UpdateData(RPT24_0000 RPT24_0000)
        {
