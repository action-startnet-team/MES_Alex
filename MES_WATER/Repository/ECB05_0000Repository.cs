                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        datas = new ECB05_0000
                        {
                            ...
                            is_null = comm.sGetString(reader["is_null"].ToString()),
                            BACK_VALUE = comm.sGetString(reader["BACK_VALUE"].ToString()),
                        };
                    }
                }
            }
      ...
      //  }
        ...
        public List<ECB05_0000> Get_DataListByQuery(string pUsrCode, string pPrgCode, string pWhere)
        {
            ...
            string sSql = @" SELECT case ECB05_0000.ERP_FIELD_CODE
                            ...
                            ,ERP_FIELD_NAME,ERP_FORM_NAME,ERP_FIELD_VALUE,is_edit,is_null,BACK_VALUE
                            from ECB05_0000";
        ...
        public void InsertData(ECB05_0000 ECB05_0000)
        {
            string sSql = "INSERT INTO " +
                          " ECB05_0000 (  ERP_FIELD_CODE,   ERP_FIELD_NAME, ERP_FORM_NAME, ERP_FIELD_VALUE, is_edit, is_null, BACK_VALUE )  " +
                          "     VALUES ( @ERP_FIELD_CODE,  @ERP_FIELD_NAME, @ERP_FORM_NAME, @ERP_FIELD_VALUE, @is_edit,@is_null, @BACK_VALUE )  ";
