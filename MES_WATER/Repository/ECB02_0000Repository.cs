...
{
    public class ECB02_0000Repository
    {
        Comm comm = new Comm();
        ...
        public ECB02_0000 GetDTO(string pTkCode)
        {
            ECB02_0000 datas = new ECB02_0000();
        ...
        /// </summary>
        /// <param name="ECB02_0000">DTO</param>
        public void InsertData(ECB02_0000 ECB02_0000)
        {
            ...
            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                con_db.Execute(sSql, ECB02_0000);
            }
        }
        ...
        /// </summary>
        /// <param name="ECB02_0000">DTO</param>
        public void UpdateData(ECB02_0000 ECB02_0000)
        {
