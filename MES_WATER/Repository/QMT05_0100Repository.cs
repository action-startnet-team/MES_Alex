...
{
    public class QMT05_0100Repository
    {
        Comm comm = new Comm();
        ...
        /// < returns > DTO QMT05_0100</returns>
        public QMT05_0100 GetDTO(string pTkCode)
        {
            QMT05_0100 datas = new QMT05_0100();
            string sSql = "";

            if (string.IsNullOrEmpty(pTkCode))
            {
                sSql = "SELECT * FROM QMT05_0100";
            }
            else
            {
                sSql = "SELECT * FROM QMT05_0100 WHERE qmt04_0100 = @qmt04_0100";
            }
            ...
            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        datas = new QMT05_0100
                        {
                            qmt05_0100 = reader.GetInt32(reader.GetOrdinal("qmt05_0100")),
                            ipqm_code = reader.GetString(reader.GetOrdinal("ipqm_code")),
        ...
        /// <summary>
        /// 根據ipqm_code取得QMT05_0100資料表內容
        /// </summary>
        /// <param name = "pTkCode" > 鍵值 / 傳空值取全部資料 </ param >
        /// < returns > List QMT05_0100</returns>
        public List<QMT05_0100> Get_DataList(string pTkCode)
        {
            List<QMT05_0100> list = new List<QMT05_0100>();
            string sSql = "";
            if (string.IsNullOrEmpty(pTkCode))
            {
                sSql = "SELECT * FROM QMT05_0100 order by ipqm_code ";
            }
            else
            {
                sSql = "SELECT * FROM QMT05_0100 WHERE ipqm_code=@ipqm_code order by scr_no";
            }
            ...
            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                ...
                while (reader.Read())
                {
                    ...
                    data.qmt05_0100 = reader.GetInt32(reader.GetOrdinal("qmt05_0100"));
                    data.ipqm_code = reader.GetString(reader.GetOrdinal("ipqm_code"));
        ...
        /// <returns></returns>
        public List<QMT05_0100> Get_DataList(string pUsrCode, string pPrgCode)
        {
            ...
            //取得該使用者可以看的資料
            sSql = "SELECT * FROM QMT05_0100 order by ";
        ...
        /// <summary>
        /// 根據pTkCode取得QMT05_0100資料表內容，並結合使用者權限
        /// </summary>
        /// <param name="pUsrCode">使用者代號</param>
        /// <param name="pPrgCode">功能代號</param>
        /// <param name="pTkCode">要抓取的條件，field value</param>
        /// <returns></returns>
        public List<QMT05_0100> Get_DataList(string pUsrCode, string pPrgCode, string pTkCode = "")
        {
            List<QMT05_0100> list = new List<QMT05_0100>();
            string foreignKey = gmv.GetKey<QMT05_0000>(new QMT05_0000());
            string sSql = "";
            if (!string.IsNullOrEmpty(pTkCode))
            {
                sSql = " SELECT *, QMB02_0000.qtest_item_name, QMB02_0000.qtest_type_code, QMB01_0000.qtest_type_name, A.field_name as qtest_item_type_name, B.usr_name " +
                       " FROM QMT05_0100 " +
                       " left join QMB02_0000 on QMB02_0000.qtest_item_code = QMT05_0100.qtest_item_code " +
                       " left join QMB01_0000 on QMB01_0000.qtest_type_code = QMB02_0000.qtest_type_code " +
                       " left join BDP21_0100 as A on A.field_code = QMT05_0100.qtest_item_type and A.code_code = 'qtest_item_type' " +
                       " left join BDP08_0000 as B on B.usr_code = QMT05_0100.usr_code " +
                       " where " + foreignKey + "=@" + foreignKey +
                       " order by QMT05_0100.scr_no";
            }
            else
            {
                sSql = " SELECT * FROM QMT05_0100 ";
            ...
            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                ...
                {
                    QMT05_0100 data = new QMT05_0100();
                    data.qmt05_0100 = comm.sGetInt32(reader["qmt05_0100"].ToString());
                    //data.qmt_value = "<a href='#' id='" + data.qmt04_0100 + "' class='qmt_code'><i class='ace-icon fa fa-pencil-square-o bigger-150'></i></a>";
                    data.ipqm_code = comm.sGetString(reader["ipqm_code"].ToString());
        ...
        /// <summary>
        /// 傳入一個QMT05_0100的DTO，存檔，一次存檔一筆
        /// </summary>
        /// <param name="QMT05_0100">DTO</param>
        public void InsertData(QMT05_0100 QMT05_0100)
        {
            string sSql = "INSERT INTO " +
                          " QMT05_0100 ( ipqm_code,  qtest_item_code,  scr_no,  qtest_up,  qtest_down, " +
                          "              qtest_item_type, is_ok, ins_date,  ins_time,  usr_code ) " +

                          "     VALUES (@ipqm_code, @qtest_item_code, @scr_no, @qtest_up, @qtest_down, " +
                          "             @qtest_item_type, @is_ok,@ins_date, @ins_time, @usr_code ) ";

            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                con_db.Execute(sSql, QMT05_0100);
            }
        }

        /// <summary>
        /// 傳入一個QMT05_0100的DTO，修改，一次修改一筆
        /// </summary>
        /// <param name="QMT05_0100">DTO</param>
        public void UpdateData(QMT05_0100 QMT05_0100)
        {
            string sSql = " UPDATE QMT05_0100                          " +
                          "    SET ipqm_code        = @ipqm_code,        " +
        ...
        {
            string sSql = "DELETE FROM QMT05_0100 WHERE qmt05_0100 = @qmt05_0100";

            using (SqlConnection con_db = comm.Set_DBConnection())
            {
                con_db.Execute(sSql, new { qmt05_0100 = pTkCode });
            }
        }
